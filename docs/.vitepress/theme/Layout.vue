...
<template>
  <Layout>
    <template #nav-bar-content-after>
      <button class="vp-event-btn" @click="openPopup">📢 最新公告</button>
    </template>

    <template #layout-bottom>
      <transition name="vp-fade">
        <div
          v-if="showPopup && noticeHtml"
          class="vp-popup-mask"
        ...
        >
          <div class="vp-popup-card">
            ...
            <div class="vp-popup-actions">
              ...
              <button class="vp-popup-btn vp-popup-close" @click="closePopup">
                朕知道了
              </button>
            </div>
          </div>
